...
* **AI Worker (FastAPI on Hugging Face):** Легковаговий сервіс для класифікації аудіо на основі нейронних мереж.
...
* **Scan Engine:** Використовує `expo-media-library` для сканування та фонового аналізу.
...
* **AI:** FastAPI, Python, Hugging Face Inference

---

## Як працює сканування

1. **Сканування:** Користувач запускає сканер.
...
*Створено з використанням архітектурного підходу "Serverless AI Inference".*
