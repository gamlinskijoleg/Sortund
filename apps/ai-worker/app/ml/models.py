...
def _sync_predict_audio_tags(
    ...
    try:
        ...
        mel_basis = librosa.filters.mel(sr=16000, n_fft=400, n_mels=128, fmin=0, fmax=8000)
        ...
        if any(g in detected_audio_tags for g in ["Guitar", "Electric guitar", "Acoustic guitar"]):
